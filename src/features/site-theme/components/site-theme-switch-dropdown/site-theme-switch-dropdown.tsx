    ...
    <Menu {...props}>
      ...
      >
        <MenuItem>
          ...
          >
            ライトテーマ
            {setting === SiteTheme.enum.light && <Check className={check} />}
          </button>
        </MenuItem>
        <MenuItem>
          <button
          ...
          >
            ダークテーマ
            {setting === SiteTheme.enum.dark && <Check className={check} />}
          </button>
        </MenuItem>
        <MenuItem>
          <button
          ...
          >
            システムテーマ
            {setting === SiteTheme.enum.system && <Check className={check} />}
          </button>
        </MenuItem>
      </MenuItems>
    </Menu>
